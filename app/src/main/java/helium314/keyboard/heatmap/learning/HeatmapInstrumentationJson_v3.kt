...
// ai-note: Phase1 step 1.3 — JSON export schema v4 with swipe geometry + correction chains
...
object HeatmapInstrumentationJson_v3 {
    ...
    private fun swipeRingBlock(): JSONArray = JSONArray().apply {
        HeatmapSwipeTraceRingBuffer_v2.copyEntriesNewestFirst().forEach { e ->
            put(
                JSONObject().apply {
