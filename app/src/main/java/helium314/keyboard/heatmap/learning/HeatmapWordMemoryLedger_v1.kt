...
// ai-note: last 300 word attempts OR 3000 chars — kept + erased, full swipe traces

package helium314.keyboard.heatmap.learning

object HeatmapWordMemoryLedger_v1 {

    const val MAX_WORD_ENTRIES = 300

    const val MAX_CHAR_BUDGET = 3000

    private val entries = ArrayDeque<WordSession_v4>()
    ...
    @JvmStatic
    fun copyOldestFirst(): List<WordSession_v4> = entries.toList()

    @JvmStatic
    fun copyNewestFirst(): List<WordSession_v4> = entries.reversed()
