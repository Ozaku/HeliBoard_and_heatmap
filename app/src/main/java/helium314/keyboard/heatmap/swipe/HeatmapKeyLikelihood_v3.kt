...
// ai-note: Block 3 step 15i — strict beat label: min likelihood + must dominate 2nd key (blocks far A on F>E>T)
...
object HeatmapKeyLikelihood_v3 {
    ...
    private const val DIST_ZERO_FACTOR = 0.48
    private const val MIN_BEST_LIKELIHOOD = 0.42
    private const val MIN_DOMINANCE_RATIO = 1.9
