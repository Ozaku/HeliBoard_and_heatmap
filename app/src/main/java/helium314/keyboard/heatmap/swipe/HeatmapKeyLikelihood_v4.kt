...
// ai-note: Block 3 step 15j — v4 likelihood: tighter radius + higher dominance (blocks A on F>E>T)
...
object HeatmapKeyLikelihood_v4 {
    ...
    private const val DIST_ZERO_FACTOR = 0.38
    private const val MIN_BEST_LIKELIHOOD = 0.48
    private const val MIN_DOMINANCE_RATIO = 2.3
