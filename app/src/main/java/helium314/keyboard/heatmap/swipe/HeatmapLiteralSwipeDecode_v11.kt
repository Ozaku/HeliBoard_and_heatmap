...
// ai-note: Block 3 step 15j — chain filter + pointer dwell + strict reachable scoring
...
object HeatmapLiteralSwipeDecode_v11 {
    ...
    private fun decodeInternal(
        ...
        val infer = HeatmapSwipeSegmentInfer_v8.infer(keyboard, pointers)
        ...
        val prefixes = HeatmapSwipePrefixEngine_v9.buildPrefixVariants(infer)
        val scored = HeatmapSwipeCandidateSource_v11.collectDictionaryCandidates(
            prefixes = prefixes,
            infer = infer,
