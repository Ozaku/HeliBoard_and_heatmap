...
// ai-note: v23 — infer v20 long-word path fix; tuning revision 2
...
object HeatmapLiteralSwipeDecode_v23 {
    ...
    private fun decodeInternal(
        ...
        val infer = HeatmapSwipeSegmentInfer_v20.infer(keyboard, pointers)
        ...
        Log.i(
            TAG,
            "mode=$mode tuning=${HeatmapSwipeTuningConstants_v2.TUNING_REVISION} " +
        ...
        val scored = HeatmapSwipeCandidateSource_v23.collectDictionaryCandidates(
            prefixes = prefixes,
            infer = infer,
