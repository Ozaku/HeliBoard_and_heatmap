...
// ai-note: Block 3 step 15n — lift-end required; fee rejected when stroke ends on T

package helium314.keyboard.heatmap.swipe

object HeatmapLiteralSwipeScore_v12 {
    ...
    fun scoreWord(
        ...
        if (!HeatmapSwipeReachableLetters_v5.isCandidateReachable(
                candidate, pathLetters, requirePathEnd = requireEndMatch,
            )
        ) {
            return Double.NEGATIVE_INFINITY
        }
