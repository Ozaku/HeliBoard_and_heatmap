...
// ai-note: Phase1 step 3.3 — position weights + soft start + middle hop relax; dict gap skips from prototype

package helium314.keyboard.heatmap.swipe

object HeatmapLiteralSwipeScore_v14 {
    ...
    private fun alignScore(candidate: String, path: List<String>): Double {
        ...
        var pathIdx = 0
        var skipsUsed = 0
        val maxSkips = HeatmapSwipeIntentPrototype_v1.maxDictPathSkips
