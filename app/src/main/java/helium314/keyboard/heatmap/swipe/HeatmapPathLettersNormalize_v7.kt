...
// ai-note: Block 3 step 15o — keep e,e from wiggle beats; no collapse to 3-letter fet
...
object HeatmapPathLettersNormalize_v7 {
    ...
    fun normalize(
        ...
        var bridged = HeatmapPathLettersNormalize_v2.collapseBridgeMiddleKeys(
            touchFilteredRaw, neighborGraph,
        )
        bridged = preserveSameKeyWiggleRuns(touchFilteredRaw, bridged)
        ...
        bridged = HeatmapSwipeStrokeTouchSet_v2.filterPathToTouched(bridged, touch.touched)
    ...
    /** ai-note: raw f,e,e,t from sensitive beats — restore double before bridge-only collapse removed it */
