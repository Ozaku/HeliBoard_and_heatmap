...
// ai-note: Block 3 step 15j — infer v8 + score v8 + expand v4 + 93/7 geo/dict
...
object HeatmapSwipeCandidateSource_v11 {
    ...
    fun collectDictionaryCandidates(
        ...
        val pathVariants = HeatmapSwipePathNeighborExpand_v4.expand(infer, layout, lightPreview)
        val neighborPrefixes = HeatmapSwipePathNeighborExpand_v4.prefixStrings(pathVariants, maxDictLen)
    ...
    private fun resolveMaxDictLen(infer: HeatmapSwipeSegmentInfer_v8.Result, strictTwoKey: Boolean): Int {
    ...
    private fun addScoredCandidate(
        ...
        val geo = HeatmapLiteralSwipeScore_v8.scoreWord(
            candidate = word,
