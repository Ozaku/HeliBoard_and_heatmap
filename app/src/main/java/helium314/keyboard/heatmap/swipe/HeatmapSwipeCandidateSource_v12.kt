...
// ai-note: Block 3 step 15k — v9 infer + v9 score + v5 expand; 95/5 geo/dict; touch-only letters
...
object HeatmapSwipeCandidateSource_v12 {
    ...
    fun collectDictionaryCandidates(
        ...
        val pathVariants = HeatmapSwipePathNeighborExpand_v5.expand(infer, layout, lightPreview)
        val neighborPrefixes = HeatmapSwipePathNeighborExpand_v5.prefixStrings(pathVariants, maxDictLen)
    ...
    private fun resolveMaxDictLen(infer: HeatmapSwipeSegmentInfer_v9.Result, strictTwoKey: Boolean): Int {
    ...
    private fun addScoredCandidate(
        ...
        val geo = HeatmapLiteralSwipeScore_v9.scoreWord(
            candidate = word,
