...
// ai-note: Block 3 step 15m — no straight-line lock; dict len policy; length band v2
...
object HeatmapSwipeCandidateSource_v14 {
    ...
    fun collectDictionaryCandidates(
        ...
        val pathVariants = HeatmapSwipePathNeighborExpand_v7.expand(infer, maxDictLen)
        val neighborPrefixes = HeatmapSwipePathNeighborExpand_v7.prefixStrings(pathVariants, maxDictLen)
    ...
    private fun addScoredCandidate(
        ...
        val geo = HeatmapLiteralSwipeScore_v11.scoreWord(
            candidate = word,
