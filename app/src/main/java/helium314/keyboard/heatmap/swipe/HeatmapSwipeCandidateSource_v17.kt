...
// ai-note: Block 3 step 15p — end policy v2 + touch v3 path; long words keep full endings
...
object HeatmapSwipeCandidateSource_v17 {
    ...
    fun collectDictionaryCandidates(
        ...
        val inferV12 = HeatmapSwipeInferCompat_v2.toV12(infer)
