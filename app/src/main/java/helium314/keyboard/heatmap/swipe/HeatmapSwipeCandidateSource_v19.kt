...
// ai-note: Block 3 step 15r — corner path decode; v18 visit-sweep reverted
...
object HeatmapSwipeCandidateSource_v19 {
    ...
    fun collectDictionaryCandidates(
        ...
        val pathVariants = HeatmapSwipePathNeighborExpand_v10.expand(inferV12, maxDictLen)
        val neighborPrefixes = HeatmapSwipePathNeighborExpand_v10.prefixStrings(pathVariants, maxDictLen)
