...
// ai-note: Phase1 step 3.3 — v14 scorer + soft start prefixes for infer v19
...
object HeatmapSwipeCandidateSource_v22 {
    ...
    private fun addScoredCandidate(
        ...
        val geo = HeatmapLiteralSwipeScore_v14.scoreWord(
            candidate = word,
