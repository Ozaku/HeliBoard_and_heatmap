...
// ai-note: Phase1 step 2.3 — dwell/transit/corner/endpoint segments for intent path
...
object HeatmapSwipeIntentClassifier_v1 {
    ...
    fun classify(
        ...
        return Result(
            ...
            intentLetters = intentLetters.distinct().let { dedupeRuns(it) },
