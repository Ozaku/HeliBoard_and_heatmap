...
// ai-note: Block 3 step 15t — min len guard for infer v18

package helium314.keyboard.heatmap.swipe

import helium314.keyboard.latin.SuggestedWords.SuggestedWordInfo

object HeatmapSwipeMinWordLenGuard_v8 {
    ...
    fun filterRanked(
        ...
        val filtered = ranked.filter { info ->
            ...
            if (!HeatmapSwipeStartLetterAnchor_v1.wordStartsWithAnchor(word, start)) {
                return@filter false
            }
