...
// ai-note: Block 3 step 15k — dwell via v5 hit zone samples only (no far-key samples)
...
object HeatmapSwipePointerDwell_v2 {
    ...
    fun detect(
        ...
        for ((segIdx, range) in segments.withIndex()) {
            ...
            for (i in range) {
                ...
                val label = HeatmapKeyLikelihood_v5.bestLabelAt(layout, x, y) ?: continue
