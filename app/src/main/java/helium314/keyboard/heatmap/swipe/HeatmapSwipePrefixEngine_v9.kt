...
// ai-note: Block 3 step 15j — dwell paths + interior double at each middle letter (feet from f>e>t)

package helium314.keyboard.heatmap.swipe

object HeatmapSwipePrefixEngine_v9 {

    private const val MAX_PREFIX_VARIANTS = 20

    fun buildPrefixVariants(infer: HeatmapSwipeSegmentInfer_v8.Result): List<String> {
    ...
    /** ai-note: f,e,t → f,e,e,t at index 1 without requiring label-run dwell */
