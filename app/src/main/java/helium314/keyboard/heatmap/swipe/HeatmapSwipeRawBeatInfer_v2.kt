...
// ai-note: Block 3 step 15q — all raw beat point labels; classifier no longer drops corners from path
...
object HeatmapSwipeRawBeatInfer_v2 {
    ...
    data class Result(
        ...
        val rawBeats: HeatmapSwipeBeat_v2.Result,
    )
    ...
    fun infer(keyboard: Keyboard, pointers: InputPointers): Result? {
        ...
        val pathLetters = HeatmapSwipeStrokeVisitOrder_v1.labelsFromBeatPoints(
