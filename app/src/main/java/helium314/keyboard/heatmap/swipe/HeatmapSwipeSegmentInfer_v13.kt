...
// ai-note: Block 3 step 15o — beat v2 + wiggle normalize v7; sensitive E zig-zag → feet not fet
...
object HeatmapSwipeSegmentInfer_v13 {
    ...
    fun infer(keyboard: Keyboard, pointers: InputPointers): Result? {
        ...
        val normalized = HeatmapPathLettersNormalize_v7.normalize(
            raw = raw.pathLetters,
            neighborGraph = graph,
            layout = layout,
            pointers = pointers,
