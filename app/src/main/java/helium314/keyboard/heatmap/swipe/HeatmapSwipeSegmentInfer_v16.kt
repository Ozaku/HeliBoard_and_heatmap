...
// ai-note: Block 3 step 15r — corner-beat path restored; v18 used visit-sweep paths
...
object HeatmapSwipeSegmentInfer_v16 {
    ...
    fun infer(keyboard: Keyboard, pointers: InputPointers): Result? {
        ...
        val normalized = HeatmapPathLettersNormalize_v10.normalize(
