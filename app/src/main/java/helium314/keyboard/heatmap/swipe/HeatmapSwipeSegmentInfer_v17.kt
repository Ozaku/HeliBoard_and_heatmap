...
// ai-note: Block 3 step 15s — literal path + wiggle hints for prefix only (not in path letters)
...
object HeatmapSwipeSegmentInfer_v17 {
    ...
    fun infer(keyboard: Keyboard, pointers: InputPointers): Result? {
        ...
        val normalized = HeatmapPathLettersNormalize_v11.normalize(
