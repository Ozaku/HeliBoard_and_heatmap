...
// ai-note: Phase1 step 3.3 — kinematics + intent classifier + v13 normalize
...
object HeatmapSwipeSegmentInfer_v19 {
    ...
    data class Result(
        ...
        val normalized: HeatmapPathLettersNormalize_v13.Normalized,
        ...
        val intent: HeatmapSwipeIntentClassifier_v1.Result,
    ...
    fun infer(keyboard: Keyboard, pointers: InputPointers): Result? {
        ...
        val intent = HeatmapSwipeIntentClassifier_v1.classify(layout, pointers, kinematics, raw)
        val normalized = HeatmapPathLettersNormalize_v13.normalize(
