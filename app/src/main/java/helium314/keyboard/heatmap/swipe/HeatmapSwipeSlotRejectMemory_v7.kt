...
// ai-note: v7 — word-memory reject hooks use v3 decode snapshot (intent path primary)
...
object HeatmapSwipeSlotRejectMemory_v7 {
    ...
    fun recordFromDecodeSnapshot(rejectedWord: String) {
        val snap = HeatmapSwipeDecodeSnapshot_v3.peek() ?: return
