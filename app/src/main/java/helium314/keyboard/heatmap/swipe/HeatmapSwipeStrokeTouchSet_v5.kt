...
// ai-note: Block 3 step 15r — stroke order for touch gate only; v5 labels; never use as full path
...
object HeatmapSwipeStrokeTouchSet_v5 {
    ...
    fun collect(
        ...
        if (labeledTotal == 0) {
            return Result(emptySet(), counts, orderRaw, counts.keys, startLabel, liftLabel)
        }
