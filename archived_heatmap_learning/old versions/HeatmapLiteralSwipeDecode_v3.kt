...
// ai-note: Block 3 step 15b — dedup path, ordered score, length band, decode snapshot stash
...
object HeatmapLiteralSwipeDecode_v3 {
    ...
    private fun decodeInternal(
        ...
        val prefixes = HeatmapSwipePrefixEngine_v2.buildPrefixVariants(infer)
        val scored = HeatmapSwipeCandidateSource_v3.collectDictionaryCandidates(
            prefixes = prefixes,
            infer = infer,
