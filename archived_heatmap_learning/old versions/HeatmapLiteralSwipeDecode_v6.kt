...
// ai-note: Block 3 step 15e — 2-key straight end gate + contraction synthetics (I'm from im path)
...
object HeatmapLiteralSwipeDecode_v6 {
    ...
    private fun decodeInternal(
        ...
        val prefixes = HeatmapSwipePrefixEngine_v5.buildPrefixVariants(infer)
        val scored = HeatmapSwipeCandidateSource_v6.collectDictionaryCandidates(
            prefixes = prefixes,
            infer = infer,
