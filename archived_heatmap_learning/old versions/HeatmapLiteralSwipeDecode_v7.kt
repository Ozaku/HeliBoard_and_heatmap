...
// ai-note: Block 3 step 15f — lift-end scoring; flayer rejected when user lifts on Y
...
object HeatmapLiteralSwipeDecode_v7 {
    ...
    private fun decodeInternal(
        ...
        val scored = HeatmapSwipeCandidateSource_v7.collectDictionaryCandidates(
            prefixes = prefixes,
            infer = infer,
