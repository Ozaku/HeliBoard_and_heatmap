...
// ai-note: Block 3 step 14b — dictionary completions via tap session only (no GESTURE JNI)
...
object HeatmapSwipeCandidateSource_v1 {
    ...
    fun fetchCompletionsForPrefix(
        ...
        val composed = ComposedData(InputPointers(1), false, prefix)
