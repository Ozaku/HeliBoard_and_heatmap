...
// ai-note: Block 3 step 15d — hard max word length on straight strokes; no +1 length softening when locked
...
object HeatmapSwipeCandidateSource_v5 {
    ...
    fun collectDictionaryCandidates(
        ...
        for (prefix in prefixes) {
            if (prefix.isEmpty() || prefix.length > maxLen) continue
            ...
            for (info in results) {
                ...
                val lengthMul = lengthMultiplier(word.length, infer.beatCount, geo, infer.straightLine.locksLetterCount)
