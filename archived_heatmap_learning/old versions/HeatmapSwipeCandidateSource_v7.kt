...
// ai-note: Block 3 step 15f — lift-end gate via score v5; GENERAL maxLen tied to beat count
...
object HeatmapSwipeCandidateSource_v7 {
    ...
    private fun addScoredCandidate(
        ...
        val geo = HeatmapLiteralSwipeScore_v5.scoreWord(
            candidate = word,
