...
// ai-note: Block 3 step 15h — v2 neighbors + preview/light mode + slot reject filter
...
object HeatmapSwipeCandidateSource_v9 {

    private const val SESSION_ID_TYPING = 0
    private const val GEO_WEIGHT = 0.88
    private const val DICT_WEIGHT = 0.12
    ...
    private const val LIGHT_MAX_PREFIXES = 7
    ...
    fun collectDictionaryCandidates(
        ...
        infer: HeatmapSwipeSegmentInfer_v6.Result,
        facilitator: DictionaryFacilitator,
        ngramContext: NgramContext,
        keyboard: Keyboard,
        settings: SettingsValuesForSuggestion,
        ...
        val pathVariants = HeatmapSwipePathNeighborExpand_v2.expand(
            infer.pathLetters, infer.pathLettersRaw, layout, lightPreview,
        )
        val neighborPrefixes = HeatmapSwipePathNeighborExpand_v2.prefixStrings(pathVariants, maxDictLen)
    ...
    private fun resolveMaxDictLen(infer: HeatmapSwipeSegmentInfer_v6.Result, strictTwoKey: Boolean): Int {
