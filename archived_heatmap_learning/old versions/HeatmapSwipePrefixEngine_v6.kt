...
// ai-note: Block 3 step 15f — prefix variants for infer v5 (lift end + path beats)

package helium314.keyboard.heatmap.swipe

object HeatmapSwipePrefixEngine_v6 {

    private const val MAX_PREFIX_VARIANTS = 18

    fun buildPrefixVariants(infer: HeatmapSwipeSegmentInfer_v5.Result): List<String> {
