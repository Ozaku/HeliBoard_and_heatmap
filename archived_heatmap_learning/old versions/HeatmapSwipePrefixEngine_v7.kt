...
// ai-note: Block 3 step 15h — prefix variants for infer v6

package helium314.keyboard.heatmap.swipe

object HeatmapSwipePrefixEngine_v7 {

    private const val MAX_PREFIX_VARIANTS = 18

    fun buildPrefixVariants(infer: HeatmapSwipeSegmentInfer_v6.Result): List<String> {
