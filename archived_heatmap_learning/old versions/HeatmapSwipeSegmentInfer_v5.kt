...
// ai-note: Block 3 step 15f — lift-pointer start/end on GENERAL strokes; path beats unchanged
...
object HeatmapSwipeSegmentInfer_v5 {
    ...
    fun infer(keyboard: Keyboard, pointers: InputPointers): Result? {
        ...
        val liftEnd = HeatmapKeyLikelihood_v1.bestLabelAt(layout, xs[size - 1], ys[size - 1])
        val touchStart = HeatmapKeyLikelihood_v1.bestLabelAt(layout, xs[0], ys[0])
