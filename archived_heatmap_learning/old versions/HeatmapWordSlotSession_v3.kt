...
// ai-note: v3 — cross-process learning reads; snapshot v4 single atomic prefs write
...
object HeatmapWordSlotSession_v3 {
    ...
    fun onWordCommitted(
        ...
        if (!HeatmapLearningSettings_v2.isLearningEnabled(context)) {
        ...
        HeatmapInstrumentationSnapshot_v4.save(context, summary, session)
        Log.i(
            TAG_ALWAYS,
    ...
    @JvmStatic
    fun liveSummary(): HeatmapInstrumentationSnapshot_v4.LiveSummary =
        HeatmapInstrumentationSnapshot_v4.LiveSummary(
            sessionGeneration = allocator.sessionGeneration(),
    ...
    fun debugSummary(context: Context): String =
        HeatmapInstrumentationSnapshot_v4.formatForDebugSummary(context, liveSummary())
