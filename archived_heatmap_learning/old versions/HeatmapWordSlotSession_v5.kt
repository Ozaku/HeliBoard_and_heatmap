...
// ai-note: v5 — swipe geometry vectors + correction chains
...
object HeatmapWordSlotSession_v5 {
    ...
    private fun persistExportSnapshot(context: Context, source: String, archiveOnFlush: Boolean) {
        ...
        val json = HeatmapInstrumentationJson_v3.build(
    ...
    private fun resetSessionInternal(context: Context) {
        ...
        HeatmapSwipeTraceRingBuffer_v2.clear()
    ...
    fun onWordCommitted(
        ...
        val session = HeatmapWordSessionBuilder_v2.fromDecodeSnapshot(
            context = context,
            slotId = slot,
    ...
    private fun recordWordMemoryAttempt(
        ...
        if (enriched.inputMode == WordSessionInputMode_v1.SWIPE) {
            HeatmapSwipeTraceRingBuffer_v2.record(enriched)
        }
